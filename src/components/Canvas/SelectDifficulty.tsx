...
export default function SelectDifficulty({gameDifficulty, setGameDifficulty}: {gameDifficulty: string, setGameDifficulty: Function}) {
  return (
    ...
    <select className="py-3 ml-2 px-1 uppercase" name="selectedDifficulty" value={gameDifficulty} onChange={(e) => setGameDifficulty(e)}>
      {
